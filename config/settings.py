...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / 'staticfiles' # Onde o collectstatic vai jogar os arquivos prontos para produção
STATICFILES_DIRS = [
    BASE_DIR / 'static', # Onde estão os arquivos estáticos do projeto (antes do collectstatic)
]
